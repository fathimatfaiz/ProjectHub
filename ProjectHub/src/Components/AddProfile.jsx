...
const AddProfile = () => {
  ...
  const handleSubmit = (e) => {
    ...
    formData.append("registerno", profile.registerno);
    formData.append("address", profile.address);
    formData.append("image", profile.image);
    formData.append("category_id", profile.category_id);

    axios
      .post("http://localhost:3000/auth/add_profile", formData)
      .then((result) => {
        if (result.data.Status) {
  ...
  return (
    <div className="d-flex justify-content-center align-items-center mt-3">
      <div className="p-3 rounded w-50 border">
        <h3 className="text-center">Add Profile Details</h3>
